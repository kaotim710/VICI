...
- Warning categories: `{'length_policy_review': 3, 'title_policy_review': 1, 'toc_signal_review': 4}`
...
| `nvda_2025_10k` | success | high | 46 | 7 | none |
| `googl_2015_10k` | success | high | 40 | 17 | Section length is outside the expected first-pass range., Start heading has TOC-like signals. |
