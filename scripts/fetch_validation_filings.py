...
INVENTORY_PATH = ROOT / "fixtures" / "gold" / "downloaded_validation_filings.json"
...
def main() -> int:
    ...
    inventory = {
        "description": "Local inventory for the held-out validation 10-K filings. Raw filings are stored under fixtures/filings/raw/ and are intentionally ignored by git.",
